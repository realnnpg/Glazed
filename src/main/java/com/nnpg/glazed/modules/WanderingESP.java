        ...
        for (net.minecraft.entity.Entity entity : mc.world.getEntities()) {
            if (entity instanceof WanderingTraderEntity) {
                ...
                if (showTracers.get()) {
                    ...
                    double x = VersionUtil.getPrevX(trader) + (trader.getX() - VersionUtil.getPrevX(trader)) * event.tickDelta;
                    double y = VersionUtil.getPrevY(trader) + (trader.getY() - VersionUtil.getPrevY(trader)) * event.tickDelta;
                    double z = VersionUtil.getPrevZ(trader) + (trader.getZ() - VersionUtil.getPrevZ(trader)) * event.tickDelta;
