...
public class AutoTreeFarmer extends Module {
    ...
    public AutoTreeFarmer() {
        super(GlazedAddon.treefarmer, "AutoTreeFarmer", "Like AutoTreeFarmer2 but faster and maybe detectable");
    }
    ...
    private boolean harvestTree() {
        ...
        if (!treeExists) {
            // Tree is gone, add random delay before moving to next farm
            actionDelay = 4 + random.nextInt(7); // Random delay between 4-10 ticks
            return true;
        }

        // Tree still exists, break it
